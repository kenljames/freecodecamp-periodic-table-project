...
--
-- Name: properties properties_atomic_number_key; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT properties_atomic_number_key FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number) ON DELETE CASCADE;
